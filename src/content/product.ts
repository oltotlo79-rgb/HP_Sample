...
export const product = {
  ...
  // 公式サイト サブキャッチ
  heroSub:
    "10 年以上コンタクトセンター向け CRM を提供してきたノウハウを結集。エントリーモデルから高機能モデルまでシームレスに利用可能で、必要な機能を、必要な時に、必要な数だけ契約できます。",
  // PPT slide 3
  productLead:
...
export const systemArchitecture = {
  ...
  blocks: [
    ...
    },
    {
      key: "db",
      title: "データベース環境",
      body: "基本はクラウド (AWS または SoftBank) 上にデータベースを設置。お客様環境への設置も可能で、セキュリティポリシー上外部に置けない場合に有効です。VPN 回線や専用線接続にも対応します。",
    },
    {
      key: "cti",
...
export const templateFlow = {
  intro:
    "あらかじめ用意されているテンプレートを利用して、たった 3 ステップで誰でも簡単に自分仕様のオリジナル画面を作成できます。",
  steps: [
    {
      no: "01",
      title: "アプリケーションテンプレートから選択",
      body: "業務カテゴリ別に用意されたアプリケーションテンプレートから、業務に近いものを選択します。",
    },
    {
      no: "02",
      title: "機能枠テンプレートから選択",
    ...
    {
      no: "03",
      title: "基本オブジェクトで画面を完成",
      body: "入力領域・プルダウン・チェックボックスなどの基本オブジェクトで項目を追加し、テスト実行で動作確認をして実運用に移ります。",
    },
  ],
  appTemplates: [
    "案件処理",
...
export const editions: {
  ...
  intro:
    "あらゆる規模のコールセンターに対応する 3 つの Edition を用意。拡張性の高いオプション機能を組み合わせることで、専門知識がなくてもニーズにベストフィットした CRM を構築できます。",
